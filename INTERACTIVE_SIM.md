...
- Make sure the preferences directories exist before running the interactive sim: `/home/<user>/.portduino/node0/prefs` through `/home/<user>/.portduino/node10/prefs`.
